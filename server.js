...
function landingPage(req) {
  const contact = escapeHtml(process.env.SUPERADMIN_EMAIL || 'owner@example.com');
  return page('Make the question memorable', `<main class="marketing-home">
    <section class="marketing-hero">
      ...
      <div class="hero-visual" aria-label="Invitation preview"><i class="float-heart h1">♥</i><i class="float-heart h2">♥</i><div class="preview-phone hero-phone"><span class="phone-notch"></span><b>Tanvi 👀</b><small>I made something for you…</small><span class="phone-cta">Open it ♥</span><div class="phone-pair"><i>☺</i><span>♥</span><i>☺</i></div></div></div>
    </section>
    <section class="entry-strip" aria-label="Account links"><span>New here? <a href="/register">Create your account</a></span><a href="/register">♡ Start with the featured template</a><a href="/login">✉ Continue with email</a></section>
    <section class="marketing-section steps-section" id="how-it-works"><header><span>How it works</span><h2>From idea to invitation in 3 simple steps.</h2></header><div class="steps-grid"><article><b>01</b><i>▣</i><div><h3>Pick a template</h3><p>Start with a beautifully designed invitation.</p></div></article><article><b>02</b><i>✎</i><div><h3>Make it yours</h3><p>Add names, questions, colors, fonts, music, and more.</p></div></article><article><b>03</b><i>➤</i><div><h3>Send the link</h3><p>Share your unique link and see their response.</p></div></article></div></section>
    <section class="marketing-section template-showcase" id="template"><div class="template-copy"><span>Featured template</span><h2>Best Friend → Date ♥</h2><p>Funny, cute, and slightly chaotic—perfect when “just asking normally” feels too boring.</p><div class="feature-chips"><i>Nickname choices</i><i>Funny reactions</i><i>Date ideas</i><i>Cute mascots</i><i>Confetti</i><i>Hinglish</i></div><a class="button primary" href="/register">Use this template →</a></div><div class="template-phones"><div class="preview-phone mini-phone"><span class="phone-notch"></span><b>What am I allowed to call you?</b><i>Madam Ji 😌</i><i>Cutie ♥</i><i>Princess 👑</i></div><div class="preview-phone mini-phone"><span class="phone-notch"></span><b>Will you go on a date with me? ♥</b><i class="filled">Haan 😌♥</i><i>Sochne do 🤭</i></div><div class="preview-phone mini-phone celebration-phone"><span class="phone-notch"></span><b>IT'S A DATE ♥</b><div>♡ ♡</div><small>SUCCESSFUL ✅😂</small></div></div></section>
    <section class="marketing-section customization" id="features"><div class="custom-preview"><div class="mini-controls"><b>Make it yours</b><label>Primary color <span class="swatches">● ● ● ● ●</span></label><label>Font style <span>Romantic⌄</span></label><label>Nickname <span>On</span></label><label>Mascots <span>On</span></label><label>Music <span>On</span></label></div><div class="preview-phone feature-phone"><span class="phone-notch"></span><b>Will you go on a date with me? ♥</b><i>Haan 😌♥</i><i>Sochne do 🤭</i><div class="phone-pair small"><i>☺</i><span>♥</span><i>☺</i></div></div></div><div class="custom-copy"><span>Make it yours</span><h2>Their invitation.<br>Your personality.</h2><p>Change everything that matters without writing a single line of code.</p><div class="detail-grid"><article><i>✎</i><div><b>Colors</b><small>Choose a palette or create your own.</small></div></article><article><i>♧</i><div><b>Nicknames</b><small>Let them choose what you call them.</small></div></article><article><i>Aa</i><div><b>Typography</b><small>Romantic, cute, elegant, or modern.</small></div></article><article><i>▣</i><div><b>Date ideas</b><small>Coffee, dinner, movie, drive, or your own idea.</small></div></article><article><i>♡</i><div><b>Questions</b><small>Rewrite every message and button.</small></div></article><article><i>✦</i><div><b>Cute details</b><small>Mascots, music, collectibles, and confetti.</small></div></article></div></div></section>
    <section class="marketing-cta"><div class="cta-heart">♡</div><div><h2>You've already thought about asking them.</h2><p>Now make it worth opening.</p></div><div><a class="button primary" href="/register">Create Your Invitation ♥</a><small>Start with the Best Friend → Date template</small></div></section>
    <footer class="marketing-footer" id="contact"><div><a class="brand" href="/">Ask Her Out <span>♡</span></a><p>Make the question memorable.</p></div><div><b>Product</b><a href="#template">Template</a><a href="#how-it-works">How it works</a><a href="#features">Features</a></div><div><b>Account</b><a href="/login">Login</a><a href="/register">Register</a></div><div><b>Contact</b><a href="mailto:${contact}">${contact}</a><a href="https://github.com/ShivPatel412/Ask-Her-Out">GitHub</a></div></footer>
  </main>`, req);
}
