...
app.get('/dashboard', requireUser, async (req, res) => {
  ...
  const qrModal = `<dialog id="qr-share-modal" class="qr-share-modal"><div class="qr-modal-body"><button type="button" class="qr-modal-close" data-close-modal="qr-share-modal" aria-label="Close">✕</button><div class="qr-header"><span class="qr-icon" style="font-size:2rem;">💌</span><h3>Share Invitation</h3><p id="qr-modal-subtitle">Scan to open or share directly</p></div><div class="qr-canvas-wrap"><canvas id="qr-modal-canvas" width="220" height="220"></canvas></div><div class="qr-modal-link-wrap"><input type="text" id="qr-modal-url" readonly value="" aria-label="Invitation Link"><button type="button" class="button small primary" id="qr-modal-copy">Copy</button></div><div class="qr-modal-actions"><a id="qr-modal-whatsapp" href="#" target="_blank" rel="noopener noreferrer" class="button small qr-btn-wa">💬 WhatsApp</a><button type="button" class="button small ghost" id="qr-modal-download-png">📥 Download</button><button type="button" class="button small ghost" id="qr-modal-native-share">💌 Share...</button></div></div></dialog>`;
